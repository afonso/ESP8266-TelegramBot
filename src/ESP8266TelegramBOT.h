...
class TelegramBOT
{
  public:
    ...
    void sendDocument(String chat_id, String document);
    void sendChatAction(String chat_id, String action);
  	void getUpdates(String offset, int limit);
    void sendLocation(String chat_id, float latitude, float longitude);
